...
public:
    EDL2(int gaussianKernelSize = 3, int minAnchorThreshold = 30, int anchorStepping = 2, int anchorThreshold = 20, double angleTolerance = 22.5 *  M_PI / 180.0, unsigned int minLineLength = 30);
    ~EDL2();
